    ...
    <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-5 gap-8 items-start">
        <div className="md:col-span-2">
          <h2 className="text-2xl font-bold font-headline mb-4">{t('castYourVote')}</h2>
          <VoteComponent topic={topic} />
        </div>

        <div className="md:col-span-3">
          <h2 className="text-2xl font-bold font-headline mb-4">{t('liveResults')}</h2>
      ...
      <section className="mt-16">
        <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-2xl font-bold font-headline">
                {t('comments', {count: topic.comments.length})}
            </h2>
        </div>
